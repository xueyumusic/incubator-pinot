...
public class PinotHelixResourceManager {
  ...
  public void deleteOfflineTable(String rawTableName) {
    ...
    LOGGER.info("Deleting table {}: Finish in {}ms", offlineTableName, (System.currentTimeMillis() - startTime));
  }
  ...
  public void deleteRealtimeTable(String rawTableName) {
    ...
    LOGGER.info("Deleting table {}: Finish in {}ms", realtimeTableName, (System.currentTimeMillis() - startTime));
  }
