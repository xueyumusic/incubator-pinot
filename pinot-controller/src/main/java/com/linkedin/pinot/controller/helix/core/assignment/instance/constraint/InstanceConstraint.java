...
public interface InstanceConstraint {
  ...
  /**
   * Applies the instance constraint, and returns a map from replica Id to satisfied instances.
   */
  Map<Integer, Set<InstanceTags>> apply(Map<Integer, Set<InstanceTags>> replicaIdToInstanceTagsMap);
}
